        ...
        >
          <span
            style={{
              ...
              borderRadius: 8,
              background:
                'color-mix(in srgb, var(--revka-status-warning) 28%, transparent)',
          ...
          {error ? (
            <div
              ...
              style={{
                ...
                borderRadius: 8,
                background:
                  'color-mix(in srgb, var(--revka-status-danger) 14%, transparent)',
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              gap: 6,
              background:
                'color-mix(in srgb, var(--revka-status-warning) 80%, transparent)',
              borderColor: 'var(--revka-status-warning)',
              color: 'var(--revka-text-primary)',
            }}
          >
...
export default function RevisionHistoryStrip({
  ...
  return (
    <>
      ...
      >
        <span className="revka-kicker" style={{ flexShrink: 0 }}>
          Revisions
        </span>

        <div
          className="revka-rev-strip-scroller"
          style={{
            flex: 1,
            minWidth: 0,
            display: 'flex',
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    animation: 'revka-rev-capsule-in 240ms ease-out both',
                  }}
                >
                  {live ? (
                    <span
                      ...
                      style={{
                        ...
                        boxShadow:
                          '0 0 6px color-mix(in srgb, var(--revka-signal-selected) 60%, transparent)',
                      }}
                    />
                  ) : null}
      ...
      <style>{`
        .revka-rev-strip-scroller::-webkit-scrollbar {
          height: 0;
          background: transparent;
        }
        .revka-rev-strip-scroller:hover {
          scrollbar-width: thin;
        }
        .revka-rev-strip-scroller:hover::-webkit-scrollbar {
          height: 6px;
        }
        .revka-rev-strip-scroller:hover::-webkit-scrollbar-thumb {
          background: var(--pc-border);
          border-radius: 3px;
        }
        .revka-rev-capsule:not(:disabled):hover {
          transform: translateY(-1px);
          background: color-mix(in srgb, var(--pc-accent-glow) 35%, transparent);
          color: var(--revka-text-primary);
        }
        @keyframes revka-rev-capsule-in {
