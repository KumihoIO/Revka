        ...
        >
          ...
          <div
            style={{
              ...
              background: 'color-mix(in srgb, var(--revka-bg-panel-strong) 78%, transparent)',
            }}
          >
            <AgentAvatar src={avatarPreviewUrl} alt={name || slug || 'Agent'} size={42} radius={10} />
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: 11.5, fontWeight: 700, color: 'var(--revka-text-primary)' }}>
                Profile image
              </div>
              <div style={{ marginTop: 2, fontSize: 10.5, color: 'var(--revka-text-faint)' }}>
                PNG, JPEG, or WebP
              </div>
            </div>
            <label
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      color: selected ? 'var(--pc-accent)' : 'var(--revka-text-secondary)',
