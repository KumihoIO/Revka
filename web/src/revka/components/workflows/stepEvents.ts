...
export const ADD_STEP_EVENT = 'revka:add-step';
...
export const OPEN_AGENT_PICKER_EVENT = 'revka:open-agent-picker';
...
declare global {
  interface WindowEventMap {
    'revka:add-step': CustomEvent<AddStepDetail>;
    'revka:open-agent-picker': CustomEvent<OpenAgentPickerDetail>;
  }
}
