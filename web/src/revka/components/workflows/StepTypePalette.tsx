 ...
 * on selection it emits `revka:add-step`, the editor canvas is the only
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Search size={16} style={{ color: 'var(--revka-text-faint)' }} />
            <Command.Input
              ref={inputRef}
            ...
            {CATEGORY_ORDER.map((category) => {
              ...
              return (
                <Command.Group
                  key={category}
                  heading={
                    <div className="revka-kicker" style={{ padding: '8px 10px 4px', letterSpacing: '0.16em' }}>
                      {meta.label}
                    </div>
                  }
                >
