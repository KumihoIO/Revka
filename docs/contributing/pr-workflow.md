# Revka PR Workflow (High-Volume Collaboration)

This document defines how Revka handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to Revka/project-native labels.
...
- Confirm any required identity-like wording uses Revka/project-native terminology.
