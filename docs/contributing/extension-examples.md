...
Revka's architecture is trait-driven and modular.
...
```rust
// In your crate: use revka::tools::traits::{Tool, ToolResult};
...
Channels let Revka communicate through any messaging platform.
...
```rust
// In your crate: use revka::channels::traits::{Channel, ChannelMessage, SendMessage};
...
Providers are LLM backend adapters. Each provider connects Revka to a different model API.
...
```rust
// In your crate: use revka::providers::traits::Provider;
...
```rust
// In your crate: use revka::memory::traits::{Memory, MemoryEntry, MemoryCategory};
