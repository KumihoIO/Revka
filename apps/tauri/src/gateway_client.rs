//! HTTP client for communicating with the Revka gateway.
...
mod tests {
    ...
    fn client_custom_url() {
        let client = GatewayClient::new("https://revka.example.com:9999", None);
        assert_eq!(client.base_url, "https://revka.example.com:9999");
    }
