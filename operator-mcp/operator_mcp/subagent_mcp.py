...
Lightweight MCP server exposing bounded operator tools so sub-agents can
spawn children, monitor siblings, coordinate hierarchically, and use Google
ADK/A2A lifecycle tooling.
...
async def list_tools() -> list[Tool]:
    return [
        ...
        # -- Google Agent Platform lifecycle --
        Tool(
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "url": {
                        "type": "string",
                        "description": "Base URL of the external agent.",
                    },
