# Revka ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for Revka edge scenarios on ESP32.
...
3. Connect UI state with Revka edge/runtime messaging
...
- [Revka Hardware Design](../../docs/hardware/hardware-peripherals-design.md)
