...
This is a complete Phase 2 UI skin package template for Construct. It exercises
...
Import `../noir-crimson-ops-phase2.zip` from the Construct Skins page.
...
Compress-Archive -Path construct-skin.json, assets -DestinationPath ../noir-crimson-ops-phase2.zip -Force
```
