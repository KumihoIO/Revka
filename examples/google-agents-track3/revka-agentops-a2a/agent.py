"""ADK agent used by the Revka Track 3 A2A Cloud Run demo."""
...
root_agent = Agent(
    name="revka_agentops_control_plane",
    model=Gemini(
        model=MODEL_NAME,
        retry_options=types.HttpRetryOptions(attempts=3),
    ),
    instruction=(
        "You are Revka Enterprise AgentOps Control Plane, a B2B operations "
