...
use revka::providers::compatible::AuthStyle;
use revka::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use revka::providers::compatible::OpenAiCompatibleProvider;
