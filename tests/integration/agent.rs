...
//!
//! Ref: https://github.com/KumihoIO/Revka/issues/618 (item 6)
...
use revka::providers::traits::ChatMessage;
use revka::providers::{ChatResponse, ConversationMessage, ToolCall};
...
async fn e2e_multi_turn_with_memory_enrichment() {
    ...
    assert!(req1_user.content.contains("project: revka"));
