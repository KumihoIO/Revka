...
![Revka dashboard gateway landing page showing the embedded web dashboard served by the local gateway](docs/assets/dashboard/dashboard-dev-01-gateway-landing.png)
